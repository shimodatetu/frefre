...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<google-protobuf>.freeze, [">= 3.12.2", "~> 3.12"])
      s.add_runtime_dependency(%q<googleapis-common-protos>.freeze, ["< 2.0", ">= 1.3.9"])
      s.add_runtime_dependency(%q<googleapis-common-protos-types>.freeze, ["< 2.0", ">= 1.0.4"])
      ...
      s.add_dependency(%q<google-protobuf>.freeze, [">= 3.12.2", "~> 3.12"])
      s.add_dependency(%q<googleapis-common-protos>.freeze, ["< 2.0", ">= 1.3.9"])
      s.add_dependency(%q<googleapis-common-protos-types>.freeze, ["< 2.0", ">= 1.0.4"])
